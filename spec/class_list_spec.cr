...
describe Cruml::ClassList do
  ...
  it "verifies instance variable duplication" do
    ...
    class_info1.instance_vars.should eq([{"@var1", "String"}])
    class_info2.instance_vars.should eq([] of Cruml::Entities::ClassInfo)
  end
  ...
  it "detects no instance variable duplication" do
    ...
    class_info1.instance_vars.should eq([{"@var1", "String"}])
    class_info2.instance_vars.should eq([{"@var2", "Int32"}])
  end
